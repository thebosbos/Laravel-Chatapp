        ...
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
            ...
            <div class="col-lg-6">
                <h1 class="display-5 fw-bold lh-1 mb-3">
                    Boussaada <span class="text-primary">Chat</span>
                </h1>
                <p class="lead">
                    Boussaada Chat is a simple chat application that allows you to chat with your frien ds and family in
                    real time.
                </p>
